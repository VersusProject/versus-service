...
public class EuclideanL2MeasureAlt2 implements Measure
{
	private MathOpsEAlt ops = new MathOpsEAlt();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_euclidean_alt2( normHist1, normHist2 );
		...
		public String getName() {
			return "EuclideanL2MeasureAlt2";
		}

		@Override
		public Class getType() {
			return EuclideanL2MeasureAlt2.class;
		}	
}