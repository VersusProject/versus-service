 ...
 * @author antoinev
 */
public class MeasureHelpSha1ServerResourceTest {
    
    private static Component component;

    private static String url;

    public MeasureHelpSha1ServerResourceTest() {
    }
    ...
    public void test() throws IOException {
        ...
        ClientResource clientResource = new ClientResource(url + "/measures/" + DummyMeasure.class.getName() + "/helpsha1");
        String expected = dummyMeasure.getHelpSHA1();
        String result = clientResource.get(String.class);
        assertNotNull(result);
        assertEquals(expected, result);
        
        expected = dummyMeasure.getHelpSHA1();
        result = new MeasuresClient(url).getMeasureHelpSha1(DummyMeasure.class.getName());
        assertNotNull(result);
        assertEquals(expected, result);
    }
}
