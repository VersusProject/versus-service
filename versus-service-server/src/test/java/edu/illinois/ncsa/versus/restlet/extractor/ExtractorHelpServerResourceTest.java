 ...
 * @author antoinev
 */
public class ExtractorHelpServerResourceTest {

    private static Component component;

    private static String url;

    public ExtractorHelpServerResourceTest() {
    }
    ...
    public void test() throws IOException {
        ...
        ClientResource clientResource = new ClientResource(url + "/extractors/" + DummyExtractor.class.getName() + "/help");
        InputStream expected = dummyExtractor.getHelpZipped();
        InputStream result = clientResource.get().getStream();
        assertNotNull(result);
        assertTrue(IOUtils.contentEquals(expected, result));
        
        expected = dummyExtractor.getHelpZipped();
        result = new ExtractorsClient(url).getExtractorZippedHelp(DummyExtractor.class.getName());
        assertNotNull(result);
        assertTrue(IOUtils.contentEquals(expected, result));
    }
}
