...
public class MeasureServerResourceTest {
    ...
    public void test() throws IOException {
        ...
        Set<Class<? extends Descriptor>> supportedFeaturesTypes = dummyMeasure.supportedFeaturesTypes();
        ...
        MeasureDescriptor expected = new MeasureDescriptor(dummyMeasure.getName(),
                dummyMeasure.getClass().getName(), dummyMeasure.getCategory(), supportedFeatures, true);
        ...
        assertMeasuresDescriptorEquals(expected, measure);
        ...
        assertMeasuresDescriptorEquals(expected, measure2);
        ...
        assertMeasuresDescriptorEquals(expected, measureFromXML);
        ...
        assertMeasuresDescriptorEquals(expected, measureFromJSON);
    ...
    private static void assertMeasuresDescriptorEquals(MeasureDescriptor measure1, MeasureDescriptor measure2) {
        assertEquals(measure1.getName(), measure2.getName());
        assertEquals(measure1.getType(), measure2.getType());
        assertEquals(measure1.getCategory(), measure2.getCategory());
        assertArrayEquals(measure1.getSupportedFeatures().toArray(), measure2.getSupportedFeatures().toArray());
        assertEquals(measure1.hasHelp(), measure2.hasHelp());
    }
